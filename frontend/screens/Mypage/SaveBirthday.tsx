...
const SaveBirthday: React.FC = () => {
    ...
    const handleConfirm = async (date: Date) => {
        ...
        try {
            ...
            dispatch(updateUserInfo({ constellation: constellation }));
    ...
    return (
        <View style={{ marginLeft: 19 }}>
            ...
            <TouchableOpacity onPress={showDatePicker} style={{ flexDirection: 'row' }}>
                <Image source={require('../../assets/cake.png')} style={{ width: 37, height: 37, marginRight: 10 }} />
                ...
                {selectedConstellation && (
                    <Text style={{ color: 'white', fontSize: 16, marginTop: 7 }}>{selectedConstellation}</Text>
                )}
